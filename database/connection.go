...
func GetInstance() *gorm.DB {
	onceDb.Do(func() {
		...
		dsn := fmt.Sprintf("%s:%s@tcp(mysql:%s)/%s?charset=utf8mb4&parseTime=True&loc=Local",databaseConfig.Mysql.DbUsername, databaseConfig.Mysql.DbPassword,databaseConfig.Mysql.DbPort,databaseConfig.Mysql.DbDatabase)
